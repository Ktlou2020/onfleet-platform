...
const checklist = [
  ...
  { label: 'Launch first live branch', done: false }
];
  ...
  return (
    <div className="fleet-demo-page">
      ...
      <section id="demo-workspace" className="fleet-demo-hero">
        <div>
          <div className="hero-pill"><CheckCircle2 size={14} /> Fleet-owner workspace preview</div>
          <h1>Explore the <span>fleet-owner platform</span>.</h1>
          <p>This workspace preview shows how fleet owners can manage fleet visibility, agreement control, collections routing, and billing logic in one place.</p>
          ...
          <div className="hero-trust-list">
            <div className="hero-trust-item"><Bike size={16} /> {fleetRows.length} sample bikes</div>
            <div className="hero-trust-item"><FileText size={16} /> {agreementRows.length} sample agreements</div>
        ...
        <div className="fleet-demo-summary-grid">
          ...
          <div className="stat"><div className="stat-label">Overdue amount</div><div className="stat-value">{fmt(overdueAmount)}</div><div className="stat-delta muted">Across sample agreements</div></div>
          <div className="stat"><div className="stat-label">Setup progress</div><div className="stat-value">{checklistDone}/{checklist.length}</div><div className="stat-delta muted">Go-live tasks complete</div></div>
        </div>
      </section>
      ...
      <section className="section fleet-demo-section">
        <div className="fleet-demo-toolbar card">
          <div>
            <div className="page-title" style={{ marginBottom: 6 }}>Fleet owner workspace preview</div>
            <div className="muted">This preview highlights the operator experience and core workflows for fleet teams.</div>
          </div>
        ...
        {tab === 'overview' ? (
          <div className="fleet-demo-layout mt-4">
            <div className="card">
              <div className="card-title"><h3>Onboarding checklist</h3><span className="badge badge-info">Go live</span></div>
            ...
            <div className="card">
              ...
              <div className="fleet-demo-list">
                ...
                <div className="fleet-demo-list-item"><Clock3 size={16} /> 1 subscription billing setup still incomplete</div>
              </div>
              <div className="fleet-demo-callout mt-4">
            ...
            <div className="card">
              <div className="card-title"><h3>Plan entitlement snapshot</h3><Badge status="active">Medium plan</Badge></div>
